...
class Ex7MyEllipseListener extends MouseAdapter {
	Ex7Drawing d;
	Ex7Ellipse l;
	Ex7UserInterface ui;
	 ...
	 */
	public Ex7MyEllipseListener(Ex7Drawing drawing, Ex7UserInterface userInterface) {
		d = drawing;
		ui = userInterface;
	}

	/**
	 * The event where the mouse is pressed. Creates a new Ex7Ellipse element
	 * and adds it to the Ex7Drawing.
	 */
	public void mousePressed(MouseEvent e) {
		int x = e.getX();
		int y = e.getY();
		l = new Ex7Ellipse(x, y, x, y);
		l.setColor(ui.getCurrentColor());
		d.addNewDrawingElement(l);
	}

	/**
	 * Updates the position of the Ex7Ellipse element when the mouse is moved
	...
	/**
	 * Sets the final end position for the Ex7Ellipse element.
	 */
