...
/**
 * This is a shape for the tetris game. It represents a 'L shaped' piece.
 * 
 * @author Mattie432
 * 
 */
public class Ex8L_Shape extends Ex8Shape {
	 ...
	 */
	public Ex8L_Shape(Ex8GameBoard gameBoard) {
		super(gameBoard);
		super.setColor(new Color(240, 171, 53));
	}
