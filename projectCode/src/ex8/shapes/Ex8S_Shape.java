...
/**
 * This is a shape for the tetris game. It represents a 'S shaped' piece.
 * 
 * @author Mattie432
 * 
 */
public class Ex8S_Shape extends Ex8Shape {
	/**
	 ...
	 */
	public Ex8S_Shape(Ex8GameBoard gameBoard) {
		super(gameBoard);
		super.setColor(new Color(13, 181, 27));
	}
	/**
